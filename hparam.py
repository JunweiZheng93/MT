hparam = {
    ...
    'training_process': '2',  # should be one of 1, 2 and 3
    ...
    'model_path': 'results/20220221223856/process_1/checkpoint.h5',
    'epochs': 200,
    'batch_size': 64,
    'split_ratio': 0.5,  # ratio to split dataset into training set and test set
    'shuffle': True,
